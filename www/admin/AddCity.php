...
if(isset($_POST['issubmit']) && $_POST['issubmit'] == 'true')
{
	...
	if(isset($_POST['CityName']))
     ...
     $CityName=stripslashes($_POST['CityName']);
          ...
          <div class="box box-primary">
			...
			?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter City Name" name="CityName" pattern="[a-zA-Z\s]+" title="Must contain alphbets only" value="<?php echo $CityName;?>">
                </div>
              </div>
              <!-- /.box-body -->
             </div>
