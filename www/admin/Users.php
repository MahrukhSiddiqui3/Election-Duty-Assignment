<?php
 include("Common.php");
 $sql="SELECT u.ID,u.RoleID,u.Postcode,u.Status,r.RoleName,u.Name,u.Password,u.Email,u.CellNumber,u.Username,DATE_FORMAT(u.DateAdded, '%M %d %Y') as Added,DATE_FORMAT(u.DateModified, '%M %d %Y') as Modified FROM users u LEFT JOIN roles r ON u.RoleID = r.ID WHERE u.ID <> 0 AND u.RoleID <> 0";
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">User Management</h3>
			  			  <button type="button" class="btn btn-block btn-primary" style="width: auto;float: right;" onclick='location.href="AddUsers.php"'>Add</button>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				 ...
				 <td><?php echo $rows['RoleName']?></td>
				  ...
				  <td><button type="button" class="btn btn-block btn-primary" style="width: auto;float: right;" onclick='location.href="EditUsers.php?EID=<?php echo $rows['ID']?>"'>Edit</button><td>
