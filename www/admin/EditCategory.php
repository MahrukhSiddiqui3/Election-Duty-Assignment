...
else
{
 ...
 $sql = "SELECT ID,CatName,Status,DATE_FORMAT(DateAdded, '%M %d %Y') as Added,DATE_FORMAT(DateModified, '%M %d %Y') as Modified FROM categories WHERE ID = '".$EID."'";
 // echo $sql;
			...
			?>
			 <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Category Name" name="CatName" pattern="[a-zA-Z\s]+" title="Must contain alphbets only" value="<?php echo $CatName;?>">
                </div>
              </div>
			  </div>
              <!-- /.box-body -->
