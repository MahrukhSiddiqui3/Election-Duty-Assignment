...
if(isset($_POST['issubmit']) && $_POST['issubmit'] == 'true')
   ...
   <div class="form-group">
				...
				<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Organization Name" name="OrganizationName" pattern="[a-zA-Z\s]+" title="Must contain alphbets only"  value="<?php echo $OrganizationName;?>">
				</div>
