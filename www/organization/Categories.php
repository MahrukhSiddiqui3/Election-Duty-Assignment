<?php
 ...
 if(isset($_POST['fordelete']) && $_POST['fordelete']=='true')
 {
	...
	// echo $keyvalues;
		$sql = "DELETE FROM categories WHERE ID IN (".$keyvalues.")";
		// echo $sql;
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
			  ...
			  <button type="button" class="btn btn-block btn-primary" style="width: auto;float: right;" onclick='location.href="AddCategory.php"'>Add</button>
			...
			<form id="frmsubmit" action="<?php echo $self?>" method="post">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><button type="button" class="btn btn-block btn-primary" style="width: auto;float: right;" onclick='location.href="EditCategory.php?EID=<?php echo $rows['ID']?>"'>Edit</button><td>
