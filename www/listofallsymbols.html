...
<head><meta charset="utf-8" /><title>
    ...
    <!--Color Css-->
    <link href="admin/css/color.css" rel="stylesheet" type="text/css" />
    <!--Font Awesome Css-->
    ...
    <!--Bxslider Css-->
    <link href="admin/css/jquery.bxslider.css" rel="stylesheet" type="text/css" />
    <!--Pretty Photo Css-->
    ...
    <link rel="alternate stylesheet" type="text/css" href="admin/css/color-red.css" title="styles1" media="screen" /><link rel="alternate stylesheet" type="text/css" href="admin/css/color-red.css" title="styles1" media="screen" /><link rel="alternate stylesheet" type="text/css" href="admin/css/color-skyblue.css" title="styles2" media="screen" /><link rel="alternate stylesheet" type="text/css" href="admin/css/color-orange.css" title="styles3" media="screen" /><link rel="stylesheet" type="text/css" href="admin/css/color-green.css" title="styles4" media="screen" /><link rel="alternate stylesheet" type="text/css" href="admin/css/color-blue.css" title="styles5" media="screen" /><link rel="alternate stylesheet" type="text/css" href="admin/css/color-brown.css" title="styles6" media="screen" />
    <!-- Color Css Files End -->
    <!-- Progress bar -->
...
<div class="aspNetHidden">
 ...
 <div id="list1">
  ...
  <!--Headre End-->
    ...
    <div class="row-fluid">
            <h1>
                <span id="ContentPlaceHolder2_lblTitle">List of all Symbols</span>
            </h1>
            <p>
    ...
    <div class="blog-box-1">
        ...
        <div class="row" >
                        ...
                        <span id="ContentPlaceHolder1_lblViewLaw"><ul>
    <li><span style="font-size: 16px;"><a href="/Documents/confidential%20wing%202018/28-6-2018/Allotted%20to%20Political%20Parties.pdf">List of Election&nbsp;Symbols&nbsp;Allotted&nbsp;to Political Parties</a></span></li>
    <li><span style="font-size: 16px;"><a href="/Documents/confidential%20wing%202018/28-6-2018/REMAINING%20ELECTION%20SYMBOLS.pdf">Remaining Election Symbols for Independent Candidates</a></span></li>
</ul>
<p>&nbsp;</p>
<ul>
</ul>
...
<ul>
    ...
    <div class="actions">
        ...
        <!--Upcoming News Times Js-->
        <script src="admin/js/jquery.countdown.js"></script>
        <!--Bxslider Js-->
        <script src="admin/js/jquery.bxslider.min.js"></script>
        <!--Filterable JS-->
        <script type="text/javascript" src="admin/js/jquery-filterable.js"></script>
        <!--Flex Timeline JS-->
        <script type="text/javascript" src="admin/js/jquery.flexisel.js"></script>
        <!--Pretty Photo Js-->
        <script src="admin/js/jquery.prettyPhoto.js" type="text/javascript" charset="utf-8"></script>
        <!-- Style Switcher -->
        <script type="text/javascript" src="admin/js/styleswitch.js"></script>
        <script type="text/javascript" src="admin/js/jquery.tabSlideOut.v1.3.js"></script>
        <!--Costom Js-->
