...
<div class="aspNetHidden">
 ...
 <div id="list1">
  ...
  <!--Headre End-->
    ...
    <h1>Newsletters</h1>
    <p>List of All the Newsletters</p>
    ...
    <div class="event-outer">
        <div class="event-row">
                    ...
                    <div class="event-heading2">
                        <a href="#"><span id="ContentPlaceHolder1_Repeater2_lblMonth_0">Oct 2017</span></a>
                    </div>
                    <ul class="gallery">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <div class="event-row-inner">
                                            <h2><a href='PrintDocument.aspx?PressId=54470&type=PDF' target= "_blank">Newsletter August - September 2017 - Issue No. 3</a></h2>
                                            
                                            <ul class="detail-row">
                                                <li><i class="fa fa-calendar"></i> 17/10/2017</li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="event-heading2">
                        <a href="#"><span id="ContentPlaceHolder1_Repeater2_lblMonth_1">Nov 2018</span></a>
                    </div>
                    <ul class="gallery">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <div class="event-row-inner">
                                            <h2><a href='PrintDocument.aspx?PressId=65758&type=PDF' target= "_blank"> Ban on Posting Transfers PB-26 Quetta-III</a></h2>
                                            
                                            <ul class="detail-row">
                                                <li><i class="fa fa-calendar"></i> 20/11/2018</li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="event-heading2">
                        <a href="#"><span id="ContentPlaceHolder1_Repeater2_lblMonth_2">Jun 2017</span></a>
                    </div>
                    <ul class="gallery">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <div class="event-row-inner">
                                            <h2><a href='PrintDocument.aspx?PressId=54315&type=PDF' target= "_blank">Newsletter English June 2017 - Issue No. 1</a></h2>
                                            
                                            <ul class="detail-row">
                                                <li><i class="fa fa-calendar"></i> 30/06/2017</li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <div class="event-row-inner">
                                            <h2><a href='PrintDocument.aspx?PressId=54316&type=PDF' target= "_blank">Newsletter Urdu June 2017 - Issue No. 1</a></h2>
                    ...
                    <div class="event-heading2">
                        <a href="#"><span id="ContentPlaceHolder1_Repeater2_lblMonth_3">Jul 2017</span></a>
                    </div>
                    <ul class="gallery">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <div class="event-row-inner">
                                            <h2><a href='PrintDocument.aspx?PressId=54337&type=PDF' target= "_blank">Newsletter  July 2017 </a></h2>
                                            
                                            <ul class="detail-row">
                                                <li><i class="fa fa-calendar"></i> 31/07/2017</li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="event-heading2">
                        <a href="#"><span id="ContentPlaceHolder1_Repeater2_lblMonth_4">Dec 2018</span></a>
                    </div>
                    <ul class="gallery">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <div class="event-row-inner">
                                            <h2><a href='PrintDocument.aspx?PressId=65820&type=Image' target= "_blank">Press Release--Last date for filing of yearly statements of assents & liabilities by the Parliamentarian and MPAs</a></h2>
                                            
                                            <ul class="detail-row">
                                                <li><i class="fa fa-calendar"></i> 20/12/2018</li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="event-heading2">
                        <a href="#"><span id="ContentPlaceHolder1_Repeater2_lblMonth_5">Dec 2017</span></a>
                    </div>
                    <ul class="gallery">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <div class="event-row-inner">
                                            <h2><a href='PrintDocument.aspx?PressId=54599&type=Image' target= "_blank">The ECP is please to constitute a Monitoring Team bye-elections PP-20- Chakwal-I</a></h2>
                                            
                                            <ul class="detail-row">
                                                <li><i class="fa fa-calendar"></i> 28/12/2017</li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="event-heading2">
                        <a href="#"><span id="ContentPlaceHolder1_Repeater2_lblMonth_6">Aug 2015</span></a>
                    </div>
                    <ul class="gallery">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <div class="event-row-inner">
                                            <h2><a href='PrintDocument.aspx?PressId=12540&type=Text' target= "_blank">ECP Newsletter</a></h2>
                                            
                                            <ul class="detail-row">
                                                <li><i class="fa fa-calendar"></i> 01/08/2015</li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
