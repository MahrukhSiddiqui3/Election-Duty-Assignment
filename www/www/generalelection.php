...
<body>
    <form method="post" action=".generalelection.php" id="form1">
...
<div class="aspNetHidden">
 ...
 <div id="list1">
  ...
  <!--Headre End-->
    ...
    <div class="row-fluid">
            <h1>
                <span id="ContentPlaceHolder2_lblTitle">General Elections</span>
            </h1>
            <p>
    ...
    <li><span style="color: #ff0000; font-size: 16px;"><span style="background-color: #ff0000;"></span><a href="https://www.ecp.gov.pk/frmdynamicnotifications.aspx?id=17">General Elections 2018&nbsp;</a></span></li>
    <li><a href="frmGenericPage.aspx?PageID=3050" target="_blank"><span style="color: black; font-size: 13px;">General Elections 2013</span></a></li>
    <li><a href="frmGenericPage.aspx?PageID=3054" target="_blank"><span style="color: black; font-size: 13px;">General Elections 2008</span></a></li>
    <li><a href="frmGenericPage.aspx?PageID=3053" target="_blank"><span style="color: black; font-size: 13px;">General Elections 2002</span></a></li>
    <li><a href="/Documents/GE%201972-1997.pdf" target="_blank"><span style="color: black; font-size: 13px;">MNAs (1972 - 1997)</span></a></li>
    <li><a href="frmGenericPage.aspx?PageID=3052" target="_blank"><span style="color: black; font-size: 13px;">Results (1988-1997)</span></a></li>
    <li><a href="/Documents/GE%2007-03-1977.pdf" target="_blank"><span style="color: black; font-size: 13px;">General Elections 1977</span></a></li>
    <li><a href="/Documents/GE%2007-12-1970.pdf" target="_blank"><span style="color: black; font-size: 13px;">General Elections 1970</span></a></li>
</ul></span>
            </div>
    </div>
    <div class="actions">
                                        ...
                                        <div class="sidebar-recent-post">
                                            ...
                                            <div class="list-area">
                                                <ul>
                                                    ...
                                                    <li><a href="listofpoliticalparties"><span></span>List of Political Parties</a></li>
