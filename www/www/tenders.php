...
<div class="aspNetHidden">
 ...
 <div id="list1">
  ...
  <!--Headre End-->
    ...
    <div class="row-fluid">
            <h1>
                <span id="ContentPlaceHolder2_lblTitle">Tenders</span>
            </h1>
            <p>
    ...
    <div class="blog-box-1">
        ...
        <div class="row" >
                        ...
                        <span id="ContentPlaceHolder1_lblViewLaw">Currently there are no Tenders</span>
            </div>
    </div>
    <div class="actions">
