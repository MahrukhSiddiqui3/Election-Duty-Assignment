<?php
 include("Common.php");
 $sql="SELECT u.ID,u.Postcode,u.RoleID,u.Status,r.RoleName,u.Name,u.Password,u.Email,u.CellNumber,u.Username,DATE_FORMAT(u.DateAdded, '%M %d %Y') as Added,DATE_FORMAT(u.DateModified, '%M %d %Y') as Modified FROM users u LEFT JOIN roles r ON u.RoleID = r.ID WHERE u.ID <> 0 AND u.RoleID <> 1";
